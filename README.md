...
| --- | ----------- | ---------- | ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- | --------------------------------------- | ----- | ---------------------------------------------------- |
| 1   | August 2026 | Onboarding | [Onboarding Azure Arc at Scale](#episode-1--onboarding-azure-arc-at-scale)                                         | [Learn](https://learn.microsoft.com/en-us/azure/azure-arc/servers/deployment-options#onboarding-methods) | [Video: Episode 1](https://youtu.be/rgrJGk6SxVY?si=b6zjQ7HbIbwHigOH) | [Blog: Episode 1](https://techcommunity.microsoft.com/blog/azurearcblog/episode-1-onboarding-azure-arc-at-scale--the-azure-arc-check-in/4546441) | [aka.ms/aaci-episode1](https://aka.ms/aaci-episode1) |
| 2   | August 2026 | Security   | [**Hotpatch for Azure Arc-enabled servers**](#episode-2--hotpatch-for-azure-arc-enabled-servers) — _next up_     | [Learn](https://learn.microsoft.com/en-us/windows-server/get-started/enable-hotpatch-azure-arc-enabled-servers?tabs=powershell) | _TBD_                                   | _TBD_ | [aka.ms/aaci-episode2](https://aka.ms/aaci-episode2) |
